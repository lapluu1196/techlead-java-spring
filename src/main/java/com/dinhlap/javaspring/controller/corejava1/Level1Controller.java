...
public class Level1Controller {
    ...
    @GetMapping("/length")
    public ResponseEntity<?> length(@RequestParam String s) {
    ...
    @GetMapping("/shortest")
    public ResponseEntity<?> shortest(@RequestParam String[] arr) {
    ...
    @GetMapping("/square")
    public ResponseEntity<?> square(@RequestParam int a) {
    ...
    @GetMapping("/max")
    public ResponseEntity<?> max(@RequestParam int[] arr) {
    ...
    @GetMapping("/median")
    public ResponseEntity<?> median(@RequestParam int[] arr) {
    ...
    @GetMapping("/count-a")
    public ResponseEntity<?> countA(@RequestParam String[] arr) {
